...
$sql1="delete from shenqingbiao where xuehao='$xuehao' and stuname='$stuname' and destination='$destination' and transportation='$transportation' and begindate='$begindate' and enddate='$enddate' and reason='$reason' and zhuangtai='$zhuangtai' and jujue='$jujue' and shijian='$shijian' ";
